...
<head profile="http://gmpg.org/xfn/11">
	<title>:.  Login Registration Model .:</title>	
...
<div class="row" style="margin-top:20px">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		...
		<form role="form" action="" method="post">
			<fieldset>
				<h2>Login Registration Model</h2>
				<hr class="colorgraph">
				<div >
                    <input type="text" id="name" name="username" class="form-control input-lg" placeholder="Username ">
				</div>
